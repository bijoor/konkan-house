...
- **konkan_house.glb** - 3D model file (auto-generated by Python script)
- **README.md** - This file
...
The `konkan_house.glb` file is automatically generated by running the Blender Python script:
