...
export function RoomForm({ room, selection }: { room: Room; selection: Selection }) {
  ...
  const wallsAsDict = normalizeToDict(room.walls);
    ...
    <div>
      ...
      <Section title="Position & size">
        <div className="grid grid-cols-2 gap-x-2">
          ...
          <NumberField label="Height" value={room.height} onCommit={(v) => patch({ height: v })} allowEmpty hint="optional; defaults to floor" />
        </div>
      </Section>
